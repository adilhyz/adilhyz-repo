...
# Thanks to Mahmoud Mohamed (Ozil)
...
declare -a OLD_DATABASE=(
						 ...
						 'adilhyz-repo.db'
						 'adilhyz-repo.db.tar.gz'
						 'adilhyz-repo.db.tar.gz.old'
						 'adilhyz-repo.files'
						 'adilhyz-repo.files.tar.gz'
						 'adilhyz-repo.files.tar.gz.old'
...
repo-add adilhyz-repo.db.tar.gz *.pkg.tar.zst
